...
float desired_pos[2] = {4*pi,4*pi}; // desired motor position
...
void setup() {
  ...
  digitalWrite(7, LOW);//Set Motor Direction
  digitalWrite(8, LOW);//Set Motor Direction
...
void loop() {
  ...
  for(i=0;i<2;i++){
    ...
    error_between = pos_velo_rad_s[1] - pos_velo_rad_s[0];
